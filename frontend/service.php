...
function getDataService()
{
    ...
    $url = API_URL_SERVICES . '/api/service';
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <div id="pricing" class="cards-2">
        <div class="container">
            <div class="row">
                <div class="col-lg-12">
                    <div class="above-heading">SERVICE</div>
            ...
            <div class="row">
                <div class="col-lg-12">
                    ...
                    <?php foreach ($services as $serv) : ?>
                        <div class="card">
                            <div class="card-body">
                                <div class="card-title"><?= $serv['serviceType'] ?></div>
                                <div class="price"><span class="currency">Rp </span><span class="value"><?= number_format($serv['PricePerUnit'], 0, '.', '.') ?></span> <br> /<?= $serv['unit'] ?></div>
                                <div class="divider"></div>
                                <p><?= $serv['description'] ?></p>
                                <div class="button-wrapper">
                                    <a class="btn-solid-reg page-scroll" href="detail-service.php?id=<?= $serv['id'] ?>">Pesan Sekarang</a>
                                </div>
                            </div>
                        </div>
                    <?php endforeach; ?>
